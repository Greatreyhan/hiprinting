    ...
    return (
        <div className='md:w-2/12 md:h-screen bg-slate-100 flex flex-col justify-between py-8 fixed left-0 top-0'>
            ...
            <div className='pt-16 md:flex hidden text-left flex-col text-gray-800 flex-1'>
                ...
                <a href='/admin/portofolio' className='cursor-pointer hover:font-semibold hover:text-sky-800 text-sm px-6 py-2 flex items-center'><MdInsertPageBreak className='text-2xl mr-1' /><span>Portofolio</span></a>
                ...
                <a href='/admin/report' className='cursor-pointer hover:font-semibold hover:text-sky-800 text-sm px-6 py-2 flex items-center'><TbReportAnalytics className='text-2xl mr-1' /><span>Career</span></a>
