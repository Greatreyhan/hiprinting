...
const PortoEditor = () => {
    ...
    const handleSendData = (e) => {
        ...
        if (img == "") {
            ...
            const dbRef = rtdbref(FIREBASE_DB, "portofolio/" + (id ? id : timestamp));
            ...
            <div className="pt-16">
                ...
                <form className="w-10/12 flex flex-col mx-auto my-8 justify-around items-center">
                    ...
                    <div className="flex w-full justify-end items-center gap-x-5">
                        <Link className="mt-4 px-6 py-2 inline-flex justify-center items-center bg-white text-sky-900 border border-sky-800 rounded-full font-semibold" to="/admin/portofolio">Kembali</Link>
                        <button
