  ...
  return (
    <div className="w-10/12 mx-auto flex justify-around pt-16 gap-x-10 bg-white">
      ...
      <div className="w-4/12 bg-slate-100 px-8 py-4 rounded-md">
        ...
        <p className="text-4xl text-sky-900 flex justify-end items-end mt-4 font-bold">{keyPorto ? keyPorto.length : 0}<span className="text-sm font-light ml-2">portofolio</span></p>
      </div>
