    ...
    return (
        <nav className="mx-auto w-full fixed z-50 bg-slate-100">
            ...
            <div className="md:w-11/12 w-full md:px-0 py-2 px-10 rounded-lg mx-auto flex justify-between items-center bg-whitebackdrop-blur-md ">
                ...
                <div className='mr-8'>
                    <a href={"https://wa.me/+6285643518494"} className='text-rose-900 border-rose-900 border hover:bg-rose-800 hover:text-white px-6 py-2 text-sm rounded-xl'>Contact Us</a>
                </div>
