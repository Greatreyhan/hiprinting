...
const ServiceCard = ({title, subtitle, description, link, image}) => {
  return (
    <div>
        ...
        <div className="flex md:flex-row flex-col md:w-10/12 gap-x-8 mx-auto py-8 items-center">
          <div className="flex-1 px-8 md:order-1 order-2">
          ...
          <div className="flex-1 h-96 md:order-2 order-1">
